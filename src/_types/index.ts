...
export interface StyledProps extends AnchorHTMLAttributes<HTMLAnchorElement> {
 ...
 */
export type EitherField<T, TKey extends keyof T = keyof T> = TKey extends keyof T ? { [P in TKey]-?:T[TKey] } & Partial<Record<Exclude<keyof T, TKey>, never>>: never;
...
export type RequiredOimit<T, K extends keyof T> = Pick<T, K> & Required<Omit<T, K>>;